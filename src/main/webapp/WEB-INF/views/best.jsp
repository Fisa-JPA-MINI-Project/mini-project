...
<head>
    ...
    <style>
        ...
        th {
            color: #2174d1; font-weight: 700; width:90px;
        }
        .best-icon {
            font-size: 2.4em;
            color: #00b1d1;
        ...
        .back-btn:hover { background: linear-gradient(90deg, #1456b7 0, #22b4ec 100%);}
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <table>
            ...
            <tr>
                <th>상태</th>
                <td><%= best.getStatus() != null ? best.getStatus() : "-" %></td>
            </tr>
        </table>
        <a class="back-btn" href="dateSelect.jsp">다른 날짜 조회</a>
    </div>
</body>
</html>
